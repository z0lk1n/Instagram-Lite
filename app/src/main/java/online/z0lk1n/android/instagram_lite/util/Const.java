...
public final class Const {
    ...
    public static final String KEY_FULLSCREEN_PHOTO = "6a669d28-db53-472a-b60f-8fa5ca4a0cbb";
    public static final int PHOTO_CAMERA_REQUEST = 1;
    public static final int OUT_OF_ARRAY_POSITION = -1;
    public static final int NOTIFY_ITEM_INSERT = 1;
    public static final int NOTIFY_ITEM_CHANGE = 0;
    public static final int NOTIFY_ITEM_REMOVE = -1;
